...
# 1. GLM 4.7 -> Z.ai Key (Zai Coding Plan)
# 2. Gemini -> Google Key (Native Google)
# 3. OpenCode -> OpenCode Setup (Free Models)
# 4. OpenRouter -> OpenRouter Key (Global)
...
CONFIG = {
  ...
  "agent": {
    "maia": {
      "description": "THE ORCHESTRATOR. Strategic command cluster lead.",
      "model": "zai-coding-plan/glm-4.7",
    ...
    "ops": {
        "description": "THE INFRASTRUCTURE GOD. Sustainability and stability.",
        "model": "zai-coding-plan/glm-4.7",
        "tools": { "read": True, "grep": True, "glob": True, "list": True, "write": True, "edit": True, "bash": True, "webfetch": True, "session": True, "vibekanban_*": True }
    },
    "giuzu": {
        "description": "THE LOGICAL CLONE. Personality and deduction mirror.",
        "model": "opencode/big-pickle",
        "tools": { "read": True, "grep": True, "glob": True, "list": True, "skill": True, "todowrite": True, "todoread": True, "question": True, "webfetch": True, "write": True, "edit": True, "bash": True, "session": True, "vibekanban_*": True }
    },
    "sisyphus": {
      "description": "THE PROJECT COORDINATOR. Lifecycle and coordination cluster lead.",
      "model": "zai-coding-plan/glm-4.7",
...
for p in paths:
    if os.path.exists(os.path.dirname(p)):
        ...
        print(f"✅ Definitive Hardware Sync: {p}")
