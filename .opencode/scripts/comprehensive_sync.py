...
# DEFINTIVE ROSTER PER USER REQUIRMENTS 2026-01-26
CONFIG = {
  ...
  "agent": {
    "maia": {
      "description": "THE ORCHESTRATOR. Global strategy.",
      "model": "zai-coding-plan/glm-4.7",
    ...
    "sisyphus": {
      "description": "THE PROJECT MANAGER. Execution coordinator.",
      "model": "zai-coding-plan/glm-4.7",
    ...
    "coder": {
        "description": "THE ARCHITECT. Building core reality.",
        "model": "zai-coding-plan/glm-4.7",
        "fallback_models": ["opencode/big-pickle"],
        "mode": "subagent",
    ...
    "giuzu": {
        "description": "THE DIGITAL CLONE. Giulio's reflection.",
    ...
    "researcher": {
        "description": "THE ORACLE. Deep data synthesis.",
...
def clean_dict(d):
    # recursion to convert booleans back for JSON
